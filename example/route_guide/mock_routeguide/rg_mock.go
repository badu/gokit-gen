...
import (
	"context"
	"github.com/badu/gokit-gen/example/route_guide/routeguide"
...
func (_m *MockRouteGuideClient) HalfDuplex(_param0 context.Context, _param1 *routeguide.Rectangle, _param2 ...grpc.CallOption) (routeguide.RouteGuide_HalfDuplexClient, error) {
	_s := []interface{}{_param0, _param1}
	for _, _x := range _param2 {
		_s = append(_s, _x)
	}
	ret := _m.ctrl.Call(_m, "HalfDuplex", _s...)
	ret0, _ := ret[0].(routeguide.RouteGuide_HalfDuplexClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockRouteGuideClientRecorder) HalfDuplex(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	_s := append([]interface{}{arg0, arg1}, arg2...)
	return _mr.mock.ctrl.RecordCall(_mr.mock, "HalfDuplex", _s...)
}

func (_m *MockRouteGuideClient) ReverseHalfDuplex(_param0 context.Context, _param1 ...grpc.CallOption) (routeguide.RouteGuide_ReverseHalfDuplexClient, error) {
	_s := []interface{}{_param0}
	for _, _x := range _param1 {
		_s = append(_s, _x)
	}
	ret := _m.ctrl.Call(_m, "ReverseHalfDuplex", _s...)
	ret0, _ := ret[0].(routeguide.RouteGuide_ReverseHalfDuplexClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockRouteGuideClientRecorder) ReverseHalfDuplex(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	_s := append([]interface{}{arg0}, arg1...)
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ReverseHalfDuplex", _s...)
}

func (_m *MockRouteGuideClient) FullDuplex(_param0 context.Context, _param1 ...grpc.CallOption) (routeguide.RouteGuide_FullDuplexClient, error) {
	_s := []interface{}{_param0}
	for _, _x := range _param1 {
		_s = append(_s, _x)
	}
	ret := _m.ctrl.Call(_m, "FullDuplex", _s...)
	ret0, _ := ret[0].(routeguide.RouteGuide_FullDuplexClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockRouteGuideClientRecorder) FullDuplex(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	_s := append([]interface{}{arg0}, arg1...)
	return _mr.mock.ctrl.RecordCall(_mr.mock, "FullDuplex", _s...)
}
