...
import (
	...
	rgmock "github.com/badu/gokit-gen/example/route_guide/mock_routeguide"
	rgpb "github.com/badu/gokit-gen/example/route_guide/routeguide"
...
func TestRouteChat(t *testing.T) {
	...
	rgclient.EXPECT().FullDuplex(gomock.Any()).Return(stream, nil)
